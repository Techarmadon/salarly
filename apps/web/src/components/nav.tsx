...
import { NavigationMenu, NavigationMenuItem, NavigationMenuLink, NavigationMenuList, navigationMenuTriggerStyle } from "@salarly/ui/components/navigation-menu";
      ...
      <NavigationMenuList className="">
        ...
        <NavigationMenuItem className="ml-auto">
          <NavigationMenuLink asChild>
            {isPending ? <Skeleton className="w-20 h-9" /> : user ? <Button onClick={signoutHandler}>Logout</Button> : <Button asChild>
